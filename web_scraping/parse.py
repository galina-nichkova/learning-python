...
if __name__ == '__main__':
    print(type(get_page_content('https://www.immobilienscout24.de/Suche/S-T/Wohnung-Miete/Berlin/Berlin/Prenzlauer-Berg-Prenzlauer-Berg/2,00-/-/EURO--800,00?enteredFrom=one_step_search')))
